<?php
if ( ! class_exists( 'brtabs_free_funnels' ) ) {
	class brtabs_free_funnels {
		...
		public function spring_premium_days_2026(): void {
			$plugin_version_capability = apply_filters( 'brfr_get_plugin_version_capability_tab_manager', 0 );
			$type = ( $plugin_version_capability >= 15 ) ? 'paid' : 'free';

			$name       = 'spring_premium_days_2026';
			$media      = '?utm_source=' . $type . '_plugin&utm_medium=admin_notice&utm_campaign=spring_2026&utm_content=top_banner_cta&utm_term=tabs';
			...
			if ( ! $is_closed and $start_time <= time() and $end_time > time() ) {
				...
				<div class="berocket-notice-template-big" style="">
					<div class="berocket-notice-description-container">
						...
						<h3>Organize product content and increase customer confidence</h3>
						<ul style="font-size: 16px">
							<li>Custom tabs for specific products and categories</li>
							<li>FAQ sections to answer questions and reduce buying doubts</li>
							<li>Show related or featured products directly inside tabs</li>
						</ul>
					...
					<div class="berocket-notice-actions-container">
						...
						<div class="berocket-notice-buttons-container">
							<a href="https://berocket.com/woocommerce-product-tabs-manager/' . $media . '" 
							   class="button notice-action-link not_berocket_button" target="_blank" 
							   style="position: static; display: inline-block; right: 0; top: 0; margin: 0;font-size: 24px;padding-left: 25px;padding-right: 25px;">Upgrade Tabs → 30% OFF</a>
